...
struct SWDownView: UIViewRepresentable {
    ...
    var inject: String {
        ...
        return "padding-left: 80px; padding-right: 80px;"
        #endif
        return ""
    }
    
    /// Markdown style
    func md(_ body: String) -> String {
        let html = """
            <!DOCTYPE html>
